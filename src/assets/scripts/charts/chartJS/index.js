...
export default (function () {
  ...
  // 2nd
  const lineChartBox_Customer_Accounts = document.getElementById(
    "line-chart-Customer-Accounts"
  );

  if (lineChartBox_Customer_Accounts) {
    const lineCtx = lineChartBox_Customer_Accounts.getContext("2d");
    lineChartBox_Customer_Accounts.height = 80;
